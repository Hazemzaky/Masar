...
import budgetStaffRoutes from './routes/budgetStaff';
import budgetLogisticsRoutes from './routes/budgetLogistics';
import budgetWaterRoutes from './routes/budgetWater';
import budgetRentalRoutes from './routes/budgetRental';
import budgetOthersRoutes from './routes/budgetOthers';
...
app.use('/api/budget/staff', budgetStaffRoutes);
app.use('/api/budget/logistics', budgetLogisticsRoutes);
app.use('/api/budget/water', budgetWaterRoutes);
app.use('/api/budget/rental', budgetRentalRoutes);
app.use('/api/budget/others', budgetOthersRoutes);
